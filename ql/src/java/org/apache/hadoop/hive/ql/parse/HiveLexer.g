...
KW_LENGTH: 'LENGTH';
KW_CLOSEST: 'CLOSEST';
KW_EXCLUSIVEJOIN: 'EXCLUSIVEJOIN';
KW_INTERSECTJOIN: 'INTERSECTJOIN';
KW_DISTANCE: 'DISTANCE';
KW_PRECEDES: 'PRECEDES';
KW_FOLLOWS: 'FOLLOWS';
//KW_MATCHES: 'MATCHES';
KW_COINCIDES: 'COINCIDES';
KW_METADATA: 'METADATA';
KW_DISCRETIZE: 'DISCRETIZE';

KW_VD_SUM: 'VD_SUM';
KW_VD_AVG: 'VD_AVG';
KW_VD_DIFF: 'VD_DIFF';
KW_VD_PRODUCT: 'VD_PRODUCT';
KW_VD_QUOTIENT: 'VD_QUOTIENT';
KW_VD_MAX: 'VD_MAX';
KW_VD_MIN: 'VD_MIN';
KW_VD_LEFT: 'VD_LEFT';
KW_VD_RIGHT: 'VD_RIGHT';
KW_EACH: 'EACH';
KW_TOTAL: 'TOTAL';
KW_MODEL: 'MODEL';
