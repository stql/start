...
public class RowContainer<Row extends List<Object>> extends AbstractRowContainer<Row> {
  ...
  public Row next() throws HiveException {
    ...
    Row ret;
/*    if (itrCursor % 1000 == 999) {
      int TTTTTTTTTTTTTTTT = 0; }
    if (itrCursor % 25000 == 24999) {
      int HHHHHHHHHHHHHHHH = 0; }
    if (itrCursor % 5000 == 4999) {
      int HHHHHHHHHTTTTTTT = 0; }
    if (itrCursor % 10000 == 9999) {
      int TTTTTTTTTHHHHHHH = 0; }*/
