...
@members {
  ...
  static {
	...
	xlateMap.put("KW_EXCLUSIVEJOIN", "EXCLUSIVEJOIN");
...
//	xlateMap.put("KW_MATCHES", "MATCHES");
	...
	xlateMap.put("KW_VD_SUM", "VD_SUM");
    xlateMap.put("KW_VD_AVG", "VD_AVG");
    xlateMap.put("KW_VD_DIFF", "VD_DIFF");
    xlateMap.put("KW_VD_PRODUCT", "VD_PRODUCT");
    xlateMap.put("KW_VD_QUOTIENT", "VD_QUOTIENT");
    xlateMap.put("KW_VD_MAX", "VD_MAX");
    xlateMap.put("KW_VD_MIN", "VD_MIN");
    xlateMap.put("KW_VD_LEFT", "VD_LEFT");
