...
public class QB {
  ...
  private HashMap<String, QBExpr> aliasToGent;
  private boolean isGenTrack;
  ...
  public QB(String outer_id, String alias, boolean isSubQ) {
    ...
    aliasToGent = new HashMap<String, QBExpr>();
  ...
  public void setGentAlias(String alias, QBExpr qbexpr) {
    aliasToGent.put(alias.toLowerCase(), qbexpr);
  }

  public void setIsGenTrack(boolean isGenTrack) {
    this.isGenTrack = isGenTrack;
  }
  ...
  public Set<String> getGentAliases() {
    return aliasToGent.keySet();
  }
  ...
  public QBExpr getGentForAlias(String alias) {
    return aliasToGent.get(alias.toLowerCase());
  }

  public boolean getIsGenTrack() {
    return isGenTrack;
  }
