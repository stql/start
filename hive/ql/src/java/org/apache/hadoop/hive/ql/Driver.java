...
public class Driver implements CommandProcessor {
  ...
  //added by me *******
  public void ASTNodeExpr (ASTNode expr) {
    System.out.println(expr.getText() + "\t" + expr.getType() + "\t" + expr.getToken().getText() + "\t" + expr.getToken().getType());
    if (expr.getChildren() != null) {
      for (Node childExpr : expr.getChildren()) {
        ASTNodeExpr((ASTNode) childExpr);
      }
    }
  }
  ...
  public int compile(String command, boolean resetTaskIds) {
    ...
    try {
      ...
      //Added by Qiang
 /*     CommonTree tmptree = (CommonTree)tree;
      DOTTreeGenerator gen = new DOTTreeGenerator();
      StringTemplate st = gen.toDOT(tmptree);
      System.out.println(st); */

 //     ASTNodeExpr(tree);


/*      CommonToken t = new CommonToken (HiveParser.KW_AND, "and");
      ASTNode n = new ASTNode (t);
      CommonToken t1 = new CommonToken (HiveParser.EQUAL, "=");
      ASTNode n1 = new ASTNode (t1);
      CommonToken t2 = new CommonToken (HiveParser.LESSTHAN, "<");
      ASTNode n2 = new ASTNode (t2);
      CommonToken t3 = new CommonToken (HiveParser.TOK_TABLE_OR_COL, "TOK_TABLE_OR_COL");
      ASTNode n3 = new ASTNode (t3);
      CommonToken t4 = new CommonToken (HiveParser.Number, "101");
      ASTNode n4 = new ASTNode (t4);
      CommonToken t5 = new CommonToken (HiveParser.TOK_TABLE_OR_COL, "TOK_TABLE_OR_COL");
      ASTNode n5 = new ASTNode (t5);
      CommonToken t6 = new CommonToken (HiveParser.Number, "300");
      ASTNode n6 = new ASTNode (t6);
      CommonToken t7 = new CommonToken (HiveParser.Identifier, "start");
      ASTNode n7 = new ASTNode (t7);
      CommonToken t8 = new CommonToken (HiveParser.Identifier, "endd");
      ASTNode n8 = new ASTNode (t8);

      List<ASTNode> l1 = new ArrayList<ASTNode> ();
      l1.add(n1);
      l1.add(n2);
      n.addChildren(l1);
      n1.setParent(n);
      ...
      List<ASTNode> l2 = new ArrayList<ASTNode> ();
      l2.add(n3);
      l2.add(n4);
      n1.addChildren(l2);
      n3.setParent(n1);
      ...
      List<ASTNode> l3 = new ArrayList<ASTNode> ();
      l3.add(n5);
      l3.add(n6);
      n2.addChildren(l3);
      n5.setParent(n2);
      ...
      List<ASTNode> l4 = new ArrayList<ASTNode> ();
      l4.add(n7);
      n3.addChildren(l4);
      n7.setParent(n4);

      List<ASTNode> l5 = new ArrayList<ASTNode> ();
      l5.add(n8);
      n5.addChildren(l5);
      n8.setParent(n5);*/
