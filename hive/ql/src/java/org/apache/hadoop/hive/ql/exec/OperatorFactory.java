...
public final class OperatorFactory {
  ...
  static {
    ...
    opvec.add(new OpTuple<ProjectDesc>(ProjectDesc.class, ProjectOperator.class));
    opvec.add(new OpTuple<CoalesceDesc>(CoalesceDesc.class, CoalesceOperator.class));
    opvec.add(new OpTuple<ClosestDesc>(ClosestDesc.class, ClosestOperator.class));
    opvec.add(new OpTuple<PairClosestDesc>(PairClosestDesc.class, PairClosestOperator.class));
    opvec.add(new OpTuple<ExclusiveJoinDesc>(ExclusiveJoinDesc.class, ExclusiveJoinOperator.class));
    opvec.add(new OpTuple<IntersectJoinDesc>(IntersectJoinDesc.class, IntersectJoinOperator.class));
    opvec.add(new OpTuple<DiscretizeDesc>(DiscretizeDesc.class, DiscretizeOperator.class));

    opvec.add(new OpTuple<VProjectDesc>(VProjectDesc.class, VProjectOperator.class));
    opvec.add(new OpTuple<PairLocationCompDesc>(PairLocationCompDesc.class, PairLocationCompOperator.class));
